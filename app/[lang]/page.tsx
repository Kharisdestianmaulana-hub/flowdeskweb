...
export default async function Home({ params }: { params: Promise<{ lang: string }> }) {
  ...
  return (
    <main className="min-h-screen flex flex-col bg-[var(--color-bg)] relative">
      {/* ANNOUNCEMENT BANNER */}
      <div className="w-full bg-[#E5D5FF] dark:bg-[var(--color-primary)]/10 border-b border-[#D5C0F9] dark:border-[var(--color-primary)]/20 py-2.5 flex items-center justify-center text-[13px] font-medium text-[#4B1A9E] dark:text-[var(--color-text-primary)] z-[110] relative">
